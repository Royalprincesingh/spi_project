...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      if (adminUsers.length === 0 || !adminUsers.find(admin => admin.username === 'Prince')) {
        // Create Prince (Order Admin) account
        const princeAdmin = {
          id: 1001,
          username: 'Prince',
          firstName: 'Prince',
        ...
        console.log('Auto-created Order Admin account: Prince/softpro');
      }
      ...
      const isSuperAdminLogin = userId === 'dhruve' && password === 'softpro';
      ...
      if (isSuperAdminLogin || isFarmerLogin || isMerchantLogin) {
        const mockUser = {
          id: 1,
          firstName: isSuperAdminLogin ? 'Dhruve' : isMerchantLogin ? 'Softpro' : 'Tanmay',
          lastName: '',
        ...
        setLoginError('Invalid ID or password. Available accounts: Super Admin (dhruve/softpro), Order Admin (Prince/softpro), Farmer (tanmay/softpro), Merchant (softpro/softpro)');
      }
      setIsLoading(false);
    }
  };
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    placeholder="Enter your user ID (tanmay)"
                    disabled={isLoading}
                  />
